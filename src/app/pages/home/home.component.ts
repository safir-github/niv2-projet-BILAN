...
@Component({
  selector: 'app-home', // Sélecteur utilisé pour intégrer ce composant dans les templates
  standalone: true, // Indique que le composant est autonome et n'a pas besoin d'un module Angular dédié
